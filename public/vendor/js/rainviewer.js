document.addEventListener('DOMContentLoaded', () => {
    let navMenu = document.getElementById("btn-radar");
    let player = document.getElementById("right-panel");
...
function changeRadarPosition(position, preloadOnly) {
    ...
    document.getElementById("timestamp").innerHTML = (new Date(nextFrame.time * 1000)).toLocaleString();
    document.getElementById("past-forcast").innerHTML = pastOrForecast;
}
